...
public abstract class HaveHandGamePlayer implements PlayerInterface {

    protected PlayerHands mPlayerHands = new PlayerHands();
    protected int mPlayerName = 0;


    public HaveHandGamePlayer() {
    }

    public HaveHandGamePlayer(int playerName) {
    ...
    public void disCardHand(int card) {
        mPlayerHands.dropCard(card, mPlayerName);
    }
